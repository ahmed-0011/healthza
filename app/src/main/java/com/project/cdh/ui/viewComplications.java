...
/////////////////////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_complications);
    ...
    void getComp()
    {
        ...
        ProgressDialog x0= ProgressDialog.show(viewComplications.this, "",
        ...
        Drc.get().addOnCompleteListener(task ->
        {
            if (task.isSuccessful()) {
                ...
                if (task.getResult().size() == 0) {
                    ...
                    AlertDialog.Builder x = new AlertDialog.Builder(viewComplications.this);
