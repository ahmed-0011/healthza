...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state)
    {
        ...
        int headerPos = stickyHeaderInterface.getHeaderPositionForItem(topChildPosition);
    ...
    private View getChildInContact(RecyclerView parent, int contactPoint, int currentHeaderPos) {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (currentHeaderPos != i) {
                boolean isChildHeader = stickyHeaderInterface.isHeader(parent.getChildAdapterPosition(child));
                if (isChildHeader) {
    ...
    private void fixLayoutSize(ViewGroup parent, View view)
    {
        ...
        int childWidthSpec = ViewGroup.getChildMeasureSpec(widthSpec, parent.getPaddingStart() + parent.getPaddingEnd(), view.getLayoutParams().width);
