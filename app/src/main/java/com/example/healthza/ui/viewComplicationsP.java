...
//////////////////////////////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_complications_p);
    ...
    void flagPatient() {
        ...
        ProgressDialog x0= ProgressDialog.show(viewComplicationsP.this, "",
        ...
        Drc.get().addOnCompleteListener(task ->
        {
            if (task.isSuccessful()) {
                ...
                if (task.getResult().size() == 0) {
                    ...
                    AlertDialog.Builder x = new AlertDialog.Builder(viewComplicationsP.this);
