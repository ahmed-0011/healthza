...
public class DViewIdentifiersP extends AppCompatActivity implements  View.OnClickListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_view_identifiers_p);
    ...
    void getIdf() {
        ...
        ProgressDialog x0= ProgressDialog.show(DViewIdentifiersP.this, "",
        ...
        Drc.get().addOnCompleteListener(task ->
        {
            if (task.isSuccessful()) {
                ...
                if( task.getResult().size() == 0)
                {
                    ...
                    AlertDialog.Builder x = new AlertDialog.Builder(DViewIdentifiersP.this);
